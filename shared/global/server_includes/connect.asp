...
<%
'---- Define the environment (live or dev) Needed for pages that don't have global.asp
Const cgIsLive = True
	...
	Select Case varDb
		...
		Case "RefronShape"
			If Not conOpenRefronShape Then
			    ...
			    'conRefronShape.ConnectionString = "Provider=MSDataShape;Data Provider=SQLOLEDB;Data Source=HUDS1708-SQL02;Initial Catalog=Refron;User ID=sa;Password=2Azx58cbQ;"
				conRefronShape.ConnectionString = "Provider=MSDataShape;Data Provider=SQLOLEDB;Data Source=HUDS1708-SQL02;Initial Catalog=Refron;User ID=dbuser;Password=oneairgas;"
			    conRefronShape.Open
	    ...
	    Case "Refron"
			If Not conOpenRefron Then
			    ...
			    'conRefron.ConnectionString = "Provider=SQLOLEDB;Data Source=HUDS1708-SQL02;Initial Catalog=Refron;User ID=Intranet;Password=Temp123;"
                conRefron.ConnectionString = "Provider=SQLOLEDB;Data Source=HUDS1708-SQL02;Initial Catalog=Refron;User ID=dbuser;Password=oneairgas;"
			    conRefron.Open
	    ...
	    Case "Imaging"
			If Not conOpenImaging Then
			    ...
			    conImaging.ConnectionString = "Provider=SQLOLEDB.1;Data Source=reflic18.refron.com;Initial Catalog=Imaging;User ID=sa;Password=openup;"
			    conImaging.Open
	    ...
	    Case "ViewPoint"
			If Not conOpenViewPoint Then
			    ...
			    conViewPoint.ConnectionString = "Provider=SQLOLEDB.1;Data Source=argprdrefsql01;Initial Catalog=sgmsdb;User ID=viewpoint;Password=Refron3818Admin33;"
			    conViewPoint.Open
	    ...
	    Case "RefronNative"
			If Not conOpenRefronNative Then
			    ...
			    'conRefronNative.ConnectionString = "Provider=SQLNCLI;Data Source=HUDS1708-SQL02;Initial Catalog=Refron;User ID=Intranet;Password=Temp123;"
                conRefronNative.ConnectionString = "Provider=SQLOLEDB;Data Source=HUDS1708-SQL02;Initial Catalog=Refron;User ID=dbuser;Password=oneairgas;"
