...
Sub BuildNewItemLookupFileJSON()
	...
	On Error Resume Next
		...
		If Err.number <> 0 then
			LogError "JSFileBuider.asp","Error","Line Number: 22", Err.description
			Err.Clear()
		End If
		...
		If Err.number <> 0 then
			LogError "JSFileBuider.asp","Error","Line Number: 41", Err.description
			Err.Clear()
		End If
		...
		If Err.number <> 0 then
			LogError "JSFileBuider.asp","Error","Line Number: 57", Err.description
			Err.Clear()
		End If
		...
		If Err.number <> 0 then
			LogError "JSFileBuider.asp","Error","Line Number: 75", Err.description
			Err.Clear()
		End If
		rs.Close
	On Error GoTo 0
